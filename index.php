  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row workingspace">
        <div class="col-lg">
          <img src="img/workingspace2.jpg" alt="workingspace" class="img-fluid">
        </div>
        <div class="col-lg">
          <h3>You <span>working</span> like at <span>home</span></h3>
          <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. A repudiandae nulla blanditiis illum.</p>
      ...
      <section class="testimonial">
        <div class="row justify-content-center quote">
          <div class="col-lg-8">
            <h5>"Bekerja lebih asyik dengan hati yang tenang. Tempatnya juga sangat nyaman dan cozy."</h5>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 justify-content-center d-flex">
            ...
            <figure class="figure">
              <img src="img/img4.jpg" class="figure-img img-fluid rounded-circle aktif" alt="testi1">
            ...
            <figure class="figure">
              <img src="img/img2.png" class="figure-img img-fluid rounded-circle" alt="testi1">
            </figure>
          </div>
        </div>
      </section>
      ...
      <div class="row footer">
        <div class="col text-center">
          <p>
            2018 All rights reserved to Faizal Abidin.
          </p>
        </div>
      </div>
      <!-- akhir footer -->
